...
const menuItems = [
  ...
  },
  {
    ...
    price: [
      180, 190, 170, 190, 180, 180, 180, 200, 210, 200, 180, 180, 180, 180, 240,
    ],
    restaurant_id: 3,
  },
  {
    ...
    price: [
      230, 400, 260, 430, 260, 430, 220, 240, 250, 220, 250, 250, 240, 230, 230,
      230, 270, 280, 220, 590, 250,
    ],
    restaurant_id: 4,
  },
  {
    ...
    price: [
      140, 150, 140, 180, 140, 160, 150, 170, 180, 180, 190, 150, 180, 190, 100,
      110, 120,
    ],
    restaurant_id: 5,
  },
  {
    ...
    price: [
      220, 280, 540, 230, 250, 260, 270, 300, 560, 230, 250, 250, 300, 560, 230,
      280, 320, 580, 260, 260, 230, 150,
    ],
    restaurant_id: 6,
  },
  {
  ...
  },
  {
    ...
    price: [
      250, 350, 650, 350, 650, 550, 550, 200, 280, 540, 260, 260, 260, 290,
    ],
    restaurant_id: 8,
  },
  {
  ...
  },
  {
    ...
    price: [
      170, 180, 200, 190, 190, 180, 190, 170, 200, 200, 220, 230, 160, 180,
    ],
    restaurant_id: 12,
  },
  {
...
menuItems.forEach((obj) => {
  let itemArray = itemArrayFromMenuObject(obj);
  itemArray.forEach((item) => fullMenuArray.push(item));
});

// const seedMenu = () => menuItems.map(({ key, value}) => ({ [key]: value }));

const seedMenu = () => Menu.bulkCreate(fullMenuArray, {});

seedMenu().catch(err => console.log(err));
module.exports = seedMenu;

/*
  const menuItems = require('../seeds/menu-seeds');
